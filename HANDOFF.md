...
권위 전투 명세는 `docs/COMBAT_HYBRID_SPEC.md`입니다. 구현·자동 검증 순서 1~7과 360×640 내부 한 회차 확인은 완료됐습니다. 콜드 부트와 첫 근무 진입은 `docs/OPENING_EXPERIENCE_SPEC.md`를 따릅니다. 다음 완료 관문은 5인 플레이테스트입니다.
...
1. 새 전투 효과음의 반복 피로감, 보스 경고 구분과 작은 `PROCESS DOWN` 표시를 관찰 항목에 포함해 `docs/PLAYTEST.md` 기준 5인 플레이테스트를 진행합니다.
2. 발견된 차단 문제만 수정합니다.
