...
const EXPECTED_PATHS: PackedStringArray = [
	...
	"game/assets/audio/sfx/enemy_break.ogg",
	"game/assets/audio/sfx/combat_hit.ogg",
	"game/assets/audio/sfx/stage_clear.ogg",
	"game/assets/audio/sfx/operator_upgrade.ogg",
	"game/assets/audio/sfx/patch_apply.ogg",
	"game/assets/audio/sfx/patch_remove.ogg",
	"game/assets/audio/sfx/boss_warning.ogg",
