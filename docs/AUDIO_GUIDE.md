...
자동 전투 타격음은 화면이 같은 적의 실제 HP 감소를 확인하고 투사체가 닿는 순간에만 재생합니다. 연속 프레임마다 울리지 않도록 활성 요원당 1.2초 기준의 화면 공격 cadence로 묶으며, 적 격파·스테이지 이동·보스·유지보수 진입과 운영 결정은 기존 의미 기반 cue로 구분합니다.
